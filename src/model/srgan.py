...
class SRResNet(nn.Module):
    ...
    def __init__(self, args, large_kernel_size=9, small_kernel_size=3, n_channels=64, n_blocks=16, scaling_factor=4):
        """
        ...
        n_subpixel_convolution_blocks = int(1)
        self.subpixel_convolutional_blocks = nn.Sequential(
            *[SubPixelConvolutionalBlock(kernel_size=small_kernel_size, n_channels=n_channels, scaling_factor=4) for i
